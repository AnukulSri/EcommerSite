...
urlpatterns = [
    ...
    path('send-feedback', views.send_feedback_view),
    path('view-feedback', views.view_feedback_view),
    ...
    path('', views.customer_signup_view),
    ...
    path('terms_condition',views.term_Condition)
]
